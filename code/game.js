var actorChars = {
  ...
  "o": Coin,
  "p": Portal,
  "k": Enemy, // A coin will wobble up and down
  "=": Lava, "|": Lava, "v": Lava  
};
...
Portal.prototype.type = "portalClosed";
...
var wobbleESpeed = 1, wobbleEDist = 1;

Enemy.prototype.act = function(step) {
  this.wobble += step * wobbleESpeed;
...
Player.prototype.moveX = function(step, level, keys) {
  ...
  if (obstacle==="startOver") {
      this.pos = new Vector(1.5, 26.5);
  } else if (obstacle)
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  if (type == "lava" && this.status == null) {
    ...
    if (!this.actors.some(function(actor) {
      ...
      Portal.prototype.type = "portalOpen";
    }
  }
  if (type == "portalOpen" && this.status == null) {
      this.status = "won";
      this.finishDelay = 1;
  }
};
